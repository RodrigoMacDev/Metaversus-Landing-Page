  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        se fosse real, você pode sentir o melhor de cada mundo do Metaverso,
        porque essa é realmente a{' '}
        ...
        em realidade. Vamos{' '}
        <span className="font-extrabold text-white">explorar</span> a maravilha
        que é o Metaverso deslizando para baixo
      </motion.p>
